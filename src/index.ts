export * from './gamepad/dom-gamepad-inputs';
export * from './gamepad/gamepad-inputs';
export * from './gamepad/gamepad';

export * from './keyboard/dom-keyboard-inputs';
export * from './keyboard/keyboard-inputs';
export * from './keyboard/keyboard';

export * from './mouse/dom-mouse-inputs';
