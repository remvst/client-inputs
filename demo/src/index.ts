...
const definitionSet = new BindingDefinitionSet([
    new BindingDefinition(
        ...
        "Jump",
        true,
        set(keyboard(Keyboard.SPACE), mouse(MouseButton.LEFT_BUTTON)),
    ),
    new BindingDefinition(
        "movement",
        "left",
    ...
    new BindingDefinition(
        ...
        "Left and right",
        true,
        set(multi(keyboard(Keyboard.LEFT), keyboard(Keyboard.RIGHT))),
    ),
    new BindingDefinition(
        "movement",
        "inspect",
        "Inspect",
        true,
        set(multi(keyboard(Keyboard.COMMAND), mouse(MouseButton.LEFT_BUTTON))),
    ),
]);
...
window.addEventListener("load", async () => {
    ...
    function frame() {
        ...
        for (const definition of definitionSet.definitions) {
            ...
            debugged[definition.label + " - " + description.join(" OR ")] =
                isDown(inputs, bindingSet);
        }
